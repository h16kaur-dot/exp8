...
import { TextField, Button, Alert, CircularProgress, Box, Typography, Paper, MenuItem } from '@mui/material';
    ...
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="100vh" bgcolor="#f5f5f5">
      <Paper elevation={3} sx={{ p: 4, width: 360 }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          />
          <TextField
            select label="Role" fullWidth margin="normal" defaultValue="user"
            {...register('role')}
          >
